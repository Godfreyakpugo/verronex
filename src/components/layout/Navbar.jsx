  ...
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-xl bg-black/60 border-b border-white/5 transition-all">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center gap-4">
        ...
        <Link
          to="/"
          className="group flex items-center gap-3 z-50 flex-shrink-0"
        >
        ...
        <div className="flex items-center gap-4 sm:gap-6 flex-1 justify-end">
          ...
          <form
            ...
            className="hidden md:block relative w-full max-w-[250px]"
          >
            <input
              type="text"
            ...
            {/* Search Icon */}
            <svg
              className="w-4 h-4 absolute left-4 top-1/2 -translate-y-1/2 text-white/40"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <Link to="/cart" className="relative group p-2">
            <svg
              className="w-6 h-6 text-gray-300 group-hover:text-fuchsia-400 transition-colors"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <div
        className={`lg:hidden absolute top-full left-0 w-full bg-black/95 backdrop-blur-2xl border-b border-white/10 transition-all duration-300 overflow-hidden ${isOpen ? "max-h-96 border-opacity-100" : "max-h-0 border-opacity-0"}`}
      >
