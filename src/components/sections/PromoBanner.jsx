...
export default function PromoBanner() {
  return (
    <section className="py-20 px-6 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-64 h-64 bg-fuchsia-600/20 blur-[120px] rounded-full"></div>

      <GlassCard className="relative p-8 md:p-16 border-fuchsia-500/20 bg-gradient-to-br from-fuchsia-900/20 to-black/40 flex flex-col md:flex-row items-center justify-between gap-8 overflow-hidden">
        
        {/* Abstract Background Element */}
        <div className="absolute right-[-10%] top-[-20%] w-96 h-96 border border-fuchsia-500/10 rounded-full"></div>
        <div className="absolute right-[-5%] top-[-10%] w-96 h-96 border border-fuchsia-500/5 rounded-full"></div>
        ...
        <div className="relative z-10 text-center md:text-left max-w-2xl">
          ...
          <p className="text-gray-400 text-lg mb-8 max-w-lg">
            Get up to 20% off on our featured collection of laptops, smartphones, and accessories. Click the button below to claim your offer and elevate your tech game today!
          </p>
        ...
        <div className="relative z-10 hidden lg:block">
          <div className="relative group">
            ...
            <div className="absolute -top-4 -left-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl animate-bounce duration-[3000ms]">
               <p className="text-fuchsia-400 font-bold">up to 15% off!</p>
            </div>
